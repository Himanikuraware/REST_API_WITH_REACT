...
//After node version 14.3 we can use await without async if that is not wrapped in any function and that is called Top-level-await. We can await the promise whic is on the top level.
